...
<body class="app sidebar-mini rtl">
  ...
  @include('admin.includes.sidenav') @yield('content')
  @include('admin.component.snackbar')
  @include('admin.component.delete-confirmation')
  ...
  @endif {{-- snack bar notification end --}} @stack('script') {!! Toastr::render() !!}
</body>
